...
def generate_base_second_message(user_name, char_type):
    return f"「{user_name}さんお仕事お疲れ様！私、周りから『合法の人間ビーズクッション』って呼ばれるくらいモチモチで癒やし系らしいから、疲れてたら1回ダイブしてみる？最近ちゃんと夜眠れてる？」"
    ...
    for cast in casts[:4]:  
        ...
        if dice_2nd <= 20:
            ...
            prompt_2nd = base_prompt_2nd + (
                ...
                "「今日もお疲れ様！いつもがんばってて本当に偉いよ。無理しすぎないでね」という風に、優しく包み込むようなタメ口で男の脳をバグらせてください。"
            )
        elif dice_2nd <= 80:
            # ③ おちゃめな匂わせ・タメ口ver（30%）
            prompt_2nd = base_prompt_2nd + (
                ...
                "敬語を完全に捨てて、フランクなタメ口にしてください。\n"
                "「合法の人間ビーズクッション」「プレミアム低反発ひざ枕」など、男が勝手にフィジカルな想像（密着感や柔らかさ）をして突っ込んでしまうお茶目なパワーワードを1つ混ぜて、短いタメ口で作ってください。"
            )
        else:
            ...
            prompt_2nd = base_prompt_2nd + (
                ...
                "パターンA：「半端ねぇマウンテン級の癒やしパワー」「たまんねぇ」「やべぇ」といった荒っぽいタメ口ボケ。\n"
